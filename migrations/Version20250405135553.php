 ...
 */
final class Version20250405135553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recipe CHANGE duration duration INT DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recipe CHANGE duration duration INT NOT NULL
        SQL);
    }
}
